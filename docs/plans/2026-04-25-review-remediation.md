...
**Acceptance:**
- App boots with zero access to the `<lan-ip-redacted>/24` subnet when env vars are set.
...
**Acceptance:**
- The grep gate catches a deliberately-introduced `<lan-ip-redacted>` literal in a test commit and refuses it.
