...
- Source comment at line 8 (`// Drag-and-drop deferred to the drag-and-drop work; strict 2-column grid is non-draggable for now.`) acknowledges this intentional deferral, but the chunk still needs to be called out as missing against prototype parity.
