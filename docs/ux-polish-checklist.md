# UX polish checklist (post-the UI audit epic)

Original 28-item list that Bret dictated on 2026-04-21 after reviewing the
post-the UI audit epic dashboard. Preserved as-is here so we can work through them
...
This is the the drag-and-drop phase scope from the audit (6 blocked chunks in `docs/audit/blocked/`).
