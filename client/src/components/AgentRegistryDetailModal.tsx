        ...
        <TabsContent value="overview" className="space-y-4 mt-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Card className="p-4">
              ...
              <div className="text-2xl font-bold font-mono">{agent.performance.successRate}%</div>
            </Card>
            <Card className="p-4">
              <div className="text-xs text-muted-foreground mb-1">Avg Response Time</div>
              <div className="text-2xl font-bold font-mono">{agent.performance.avgResponseTime}ms</div>
            </Card>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <Card className="p-4">
              ...
              <div className="text-lg font-semibold">{agent.performance.totalExecutions.toLocaleString()}</div>
            </Card>
            <Card className="p-4">
              <div className="text-xs text-muted-foreground mb-1">Last Used</div>
              <div className="text-sm">{new Date(agent.performance.lastUsed).toLocaleString()}</div>
            </Card>
          </div>
        </TabsContent>
        ...
        <TabsContent value="performance" className="space-y-4 mt-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Card className="p-4">
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  <span>{agent.performance.avgResponseTime}ms</span>
                  <span className="text-muted-foreground">Target: &lt;2000ms</span>
                </div>
                <Progress 
                  value={Math.min(100, (2000 - agent.performance.avgResponseTime) / 20)} 
                  className="h-2" 
                />
              </div>
            </Card>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <div className="text-sm font-mono">{agent.configuration.model}</div>
              </div>
              <div className="space-y-2">
                <div className="text-sm text-muted-foreground">Temperature</div>
                <div className="text-sm font-mono">{agent.configuration.temperature}</div>
              </div>
              <div className="space-y-2">
                <div className="text-sm text-muted-foreground">Max Tokens</div>
                <div className="text-sm font-mono">{agent.configuration.maxTokens}</div>
              </div>
              <div className="space-y-2">
                <div className="text-sm text-muted-foreground">Timeout</div>
                <div className="text-sm font-mono">{agent.configuration.timeout}s</div>
              </div>
            </div>
          </div>
        </TabsContent>
