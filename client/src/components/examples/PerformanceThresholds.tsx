...
export default function PerformanceThresholdsExample() {
  ...
  const thresholds = [
    ...
    { id: '3', name: 'Network I/O', current: 450, max: 1000, unit: 'Mbps', warning: 70, critical: 85 },
    { id: '4', name: 'Active Connections', current: 1250, max: 2000, unit: 'conns', warning: 75, critical: 90 },
  ];
