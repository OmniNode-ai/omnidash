...
describe('DataTable', () => {
  ...
  it('should support search functionality', async () => {
    ...
    render(<DataTable data={mockData} columns={mockColumns} searchKeys={['name']} />);
  ...
  it('should paginate data when pageSize is set', () => {
    ...
    render(<DataTable data={largeData} columns={mockColumns} defaultPageSize={10} />);
  ...
  it('should render custom title when provided', () => {
    render(<DataTable data={mockData} columns={mockColumns} title="Custom Table Title" />);
  ...
  it('should respect maxHeight', () => {
    const { container } = render(
      <DataTable data={mockData} columns={mockColumns} maxHeight="400px" />
    );
