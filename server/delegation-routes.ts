...
router.get('/summary', async (req, res) => {
  try {
    ...
    console.error('[delegation] Error fetching summary:', error instanceof Error ? error.message : String(error));
...
router.get('/by-task-type', async (req, res) => {
  try {
    ...
    console.error('[delegation] Error fetching by-task-type:', error instanceof Error ? error.message : String(error));
...
router.get('/by-model', async (req, res) => {
  try {
    ...
    console.error('[delegation] Error fetching by-model:', error instanceof Error ? error.message : String(error));
...
router.get('/cost-savings', async (req, res) => {
  try {
    ...
    console.error('[delegation] Error fetching cost-savings:', error instanceof Error ? error.message : String(error));
...
router.get('/quality-gates', async (req, res) => {
  try {
    ...
    console.error('[delegation] Error fetching quality-gates:', error instanceof Error ? error.message : String(error));
...
router.get('/shadow-divergence', async (req, res) => {
  try {
    ...
    console.error('[delegation] Error fetching shadow-divergence:', error instanceof Error ? error.message : String(error));
...
router.get('/decisions', async (req, res) => {
  try {
    ...
    console.error('[delegation] Error fetching decisions:', error instanceof Error ? error.message : String(error));
...
router.get('/trend', async (req, res) => {
  try {
    ...
    console.error('[delegation] Error fetching trend:', error instanceof Error ? error.message : String(error));
