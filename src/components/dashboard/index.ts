...
export const componentImports: Record<string, ReturnType<typeof lazy>> = {
  ...
  'delegation/DelegationCostBreakdownWidget': lazy(() => import('./delegation/DelegationCostBreakdownWidget')),
  ...
  'delegation/DelegationModelOutputWidget': lazy(() => import('./delegation/DelegationModelOutputWidget')),
  ...
  'delegation-control-plane/DelegationControlPlane': lazy(() => import('./delegation-control-plane/DelegationControlPlane')),
  'delegation-control-plane/DelegateTaskWidget': lazy(() => import('./delegation-control-plane/DelegateTaskWidget')),
