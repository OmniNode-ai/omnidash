...
const STORY_FILES: Array<{ rel: string; id: string; widget: boolean }> = [
  ...
  { rel: 'src/components/dashboard/cost-by-model-2d/CostByModelBars.stories.tsx', id: 'CostByModelBars.stories', widget: true },
  { rel: 'src/components/dashboard/quality/QualityScorePanel.stories.tsx', id: 'QualityScorePanel.stories', widget: true },
  { rel: 'src/components/dashboard/quality-score-panel-2d/QualityScoreHistogram.stories.tsx', id: 'QualityScoreHistogram.stories', widget: true },
